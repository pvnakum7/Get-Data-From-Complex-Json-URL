...
//
//     final gitRepo = gitRepoFromJson(jsonString);

import 'dart:convert';

GitRepo gitRepoFromJson(String str) => GitRepo.fromJson(json.decode(str));

String gitRepoToJson(GitRepo data) => json.encode(data.toJson());
...
class GitRepo {
  ...
  factory GitRepo.fromJson(Map<String, dynamic> json) => new GitRepo(
